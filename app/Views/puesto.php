                ...
                <table class="table mt-3 table-hover table-bordered">
                    ...
                    <tbody>
                        ...
                        foreach ($datos as $empleado) {
                            ...
                            <tr>
                                <td><?php echo ($empleado['puesto_id']) ?></td>
                                <td><?= $empleado['puesto']; ?></td>                            
                                <td class="d-flex justify-content-center gap-2 ">
                                    <a href="<?= base_url('update_empleado/') . $empleado['puesto_id']; ?>" class="btn btn-outline-dark"><i class="bi bi-pencil"></i></a>
                                    <a href="<?= base_url('eliminar_empleado/') . $empleado['puesto_id']; ?>"
